...
export const PRODUCTS: Product[] = [
  {
    ...
    image: "/images/products/better-together-white-main.webp",
    alt: "Better Together LED Neon Sign - Pink Glow on White Brick Wall",
    variants: [
      {
        color: "Warm White",
        images: [
          "/images/products/better-together-white-main.webp",
          "/images/products/better-together-white-wedding.webp",
          "/images/products/better-together-white-bedroom.webp",
          "/images/products/better-together-white-day-night.webp",
        ],
      },
      {
        color: "Pink",
        images: [
          "/images/products/better-together-pink-main.webp",
          "/images/products/better-together-pink-wedding.webp",
          "/images/products/better-together-pink-bedroom.webp",
          "/images/products/better-together-pink-day-night.webp",
        ],
      },
    ],
  ...
  },
  {
    ...
    colors: ["Warm White", "Pink"],
    image: "/images/products/good-vibes-white-main.webp",
    alt: "Good Vibes Only neon sign showing high-quality silicone tubing in bedroom",
    variants: [
      {
        color: "Warm White",
        images: [
          "/images/products/good-vibes-white-main.webp",
          "/images/products/good-vibes-white-bedroom.webp",
          "/images/products/good-vibes-white-studio.webp",
          "/images/products/good-vibes-white-day-night.webp",
        ],
      },
      {
        color: "Pink",
        images: [
          "/images/products/good-vibes-pink-main.webp",
          "/images/products/good-vibes-pink-bedroom.webp",
          "/images/products/good-vibes-pink-studio.webp",
          "/images/products/good-vibes-pink-day-night.webp",
        ],
      },
    ],
  ...
  },
  {
    ...
    colors: ["Warm White", "Pink"],
    image: "/images/products/this-must-be-white-main.webp",
    alt: "This Must Be The Place neon sign in living room wall decor setting",
    variants: [
      {
        color: "Warm White",
        images: [
          "/images/products/this-must-be-white-main.webp",
          "/images/products/this-must-be-white-living-room.webp",
          "/images/products/this-must-be-white-day-night.webp",
        ],
      },
      {
        color: "Pink",
        images: [
          "/images/products/this-must-be-pink-main.webp",
          "/images/products/this-must-be-pink-living-room.webp",
          "/images/products/this-must-be-pink-day-night.webp",
        ],
      },
    ],
    relatedHref: "/products/good-vibes-only-neon-sign",
  ...
  },
  {
    ...
    colors: ["Warm White", "Pink"],
    image: "/images/products/cheers-white-main.webp",
    alt: "Cheers LED neon bar sign for home bar and kitchen party decor",
    variants: [
      {
        color: "Warm White",
        images: [
          "/images/products/cheers-white-main.webp",
          "/images/products/cheers-white-bar.webp",
          "/images/products/cheers-white-day-night.webp",
        ],
      },
      {
        color: "Pink",
        images: [
          "/images/products/cheers-pink-main.webp",
          "/images/products/cheers-pink-bar.webp",
          "/images/products/cheers-pink-day-night.webp",
        ],
      },
    ],
